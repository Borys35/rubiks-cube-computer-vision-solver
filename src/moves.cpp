...
CubieCube create_base_move(MoveIndex move_idx)
{
    ...
    {
    case U:
        c.cp = {Corner::UFL, Corner::ULB, Corner::UBR, Corner::URF, Corner::DFR, Corner::DFL, Corner::DLB, Corner::DBR};
    ...
    case D:
        c.cp = {Corner::URF, Corner::UFL, Corner::ULB, Corner::UBR, Corner::DLB, Corner::DFR, Corner::DBR, Corner::DFL};
        c.co = {0, 0, 0, 0, 0, 0, 0, 0};
    ...
    case R:
        c.cp = {Corner::UBR, Corner::UFL, Corner::ULB, Corner::DBR, Corner::URF, Corner::DFL, Corner::DLB, Corner::DFR};
    ...
    case F:
        c.cp = {Corner::UFL, Corner::DFL, Corner::ULB, Corner::UBR, Corner::DFR, Corner::URF, Corner::DLB, Corner::DBR};
    ...
    case B:
        c.cp = {Corner::URF, Corner::UFL, Corner::UBR, Corner::DBR, Corner::DLB, Corner::DFL, Corner::ULB, Corner::DFR};
